        ...
        <div className="h-16 px-4 border rounded-2xl cl-div overflow-auto space-x-6 text-2xl sm:text-3xl sm:space-x-10 flex justify-center items-center">
          <NavLink
            ...
            className={(navData) =>
              navData.isActive
                ? "text-gray-700 "
                : "text-gray-500 hover:scale-110 hover:scale-150 transition duration-300"
            }
          >
          ...
          <NavLink
            ...
            className={(navData) =>
              navData.isActive
                ? "text-gray-700"
                : "text-gray-500 hover:scale-150 transition duration-300"
            }
          >
            <FaLaptopCode />
          </NavLink>
          ...
          <a
            ...
            target="_blank"
            className="text-gray-500 hover:scale-150 transition duration-400"
          >
            <MdMarkEmailUnread />
          </a>
        </div>
